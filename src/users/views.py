    ...
    if request.method == "POST":
        ...
        if login_form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, f'An Error occurred while trying to Log in.Please try again.')
        else:
...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            messages.error(request, 'An error occurred while trying to register. Please try again.')
            return render(request, "views/register.html", {"register_form": register_form})
